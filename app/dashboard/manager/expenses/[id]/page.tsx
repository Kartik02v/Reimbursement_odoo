    ...
    return (
      <div className="min-h-screen">
        ...
        <div className="p-8">
          ...
          <Link href="/dashboard/manager/expenses">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="flex items-center justify-between py-2 border-b">
                ...
                <span className="font-medium">{expense.paidBy || 'Personal'}</span>
              </div>
              <div className="flex items-center justify-between py-2 border-b">
                <span className="flex items-center gap-2 text-muted-foreground">
              ...
              <CardContent>
                <div className="flex items-center gap-3 p-3 border rounded-lg bg-muted/30">
                  <div className="p-2 rounded-lg bg-primary/10 text-primary">
                    <Link href={expense.attachmentUrl} target="_blank">
                      <FileText className="w-6 h-6" />
                    </Link>
                  </div>
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium">Supporting Document</p>
                    <p className="text-xs text-muted-foreground truncate">File attached to expense</p>
                  </div>
                  <Button variant="ghost" size="sm" asChild>
                    <Link href={expense.attachmentUrl} target="_blank" className="flex items-center">
