...
export default function ManagerDashboardPage() {
  ...
  const { expenses, getPendingApprovalsForUser } = useExpenses();
  ...
  return (
    <div className="min-h-screen">
      <Header
        ...
        description={`Review team approvals and track your own expenses.`}
        action={
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
              ...
              {recentExpenses.length === 0 ? (
                ...
                <div className="space-y-3">
                  {recentExpenses.map((expense) => (
                    <Link
                      key={expense.id}
                      href={`/dashboard/employee/expenses/${expense.id}`}
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Approval shortcuts</CardDescription>
            </CardHeader>
            <CardContent className="space-y-2">
              <Link href="/dashboard/manager/approvals" className="block">
                <Button variant="outline" className="w-full justify-start">
                  <CheckCircle2 className="w-4 h-4 mr-2" />
                  Review Approvals ({pendingApprovals.length})
                </Button>
              </Link>
              <Link href="/dashboard/employee/expenses/new" className="block">
                <Button variant="outline" className="w-full justify-start">
                  <Plus className="w-4 h-4 mr-2" />
                  Submit New Expense
                </Button>
              </Link>
              <Link href="/dashboard/employee/expenses?status=draft" className="block">
                <Button variant="outline" className="w-full justify-start">
